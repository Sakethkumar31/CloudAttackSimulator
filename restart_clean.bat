...
REM Preserve persistent volumes to avoid wiping CALDERA/Neo4j state
echo [Cloud Attack Lab] Preserving Docker volumes to keep CALDERA agents and database data...
REM wsl -d Ubuntu-22.04 -- bash -lc "docker volume prune -f"
